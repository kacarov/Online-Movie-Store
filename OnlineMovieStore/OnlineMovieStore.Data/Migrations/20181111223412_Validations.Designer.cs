...
namespace OnlineMovieStore.Data.Migrations
{
    ...
    [Migration("20181111223412_Validations")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = "cfddf7d7-31ca-4484-a95b-dfef7a536acc", RoleId = "1" }
                    );
                });
            ...
            modelBuilder.Entity("OnlineMovieStore.Models.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "cfddf7d7-31ca-4484-a95b-dfef7a536acc", AccessFailedCount = 0, Balance = 0.0, ConcurrencyStamp = "d3238381-f5ae-4759-b2fa-28e308342ba4", Email = "vksn@mail.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "VKS@MAIL.COM", NormalizedUserName = "VKSADMIN", PasswordHash = "AQAAAAEAACcQAAAAEPbNqYVlZ7QCAZoqtOqlXKkiTreivACAtwxkdWIRlmgbDqMlBD0MNaSXHMiceMAr2A==", PhoneNumber = "+55555", PhoneNumberConfirmed = true, SecurityStamp = "49879aa4-01e7-4819-aa27-c7a4103f9983", TwoFactorEnabled = false, UserName = "VksAdmin" }
                    );
                });
